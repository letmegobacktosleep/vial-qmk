...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LCTL,   KC_LGUI,   MO(3),   KC_LALT,   KC_SPACE,  MO(1),        KC_SPACE,  MO(2),   KC_RALT,   KC_RGUI,   KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[1] = LAYOUT(
		...
		MS_BTN2, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		MS_BTN1, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
