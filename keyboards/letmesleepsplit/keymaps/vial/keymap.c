...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LSFT, KC_RSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_DOT,  KC_COMM, KC_SLSH,
		KC_UP,
		KC_LCTL, KC_LGUI, KC_LALT, MO(2),   KC_RGUI, KC_RCTL,
		KC_SPACE,KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT,
		MO(1),   KC_SPACE
	),
